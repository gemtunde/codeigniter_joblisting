            ...
            <div class="panel panel-default" style="margin-top:50px">
                ...
                <div class="panel-body">
                    <?php echo form_open('home/register_process'); ?>
                        ...
                        <div class="form-group">
                           <input type='submit' name="u_register" class="btn btn-success" value="Register Here" />
                        <a href='<?php echo site_url('home'); ?>' class='btn btn-warning btn-sm p-2'>Login Here</a>
                        </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
